...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.Json"
COPYRIGHT = 'Copyright 2012 Jeremy D. Miller, Joshua Arnold, et al. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.Json.sln', :clrversion => CLR_TOOLS_VERSION
...
task :unit_test => :compile do
  ...
  runner.executeTests ['FubuMVC.Json.Tests']
end
